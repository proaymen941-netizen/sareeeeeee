...
export default function ProductDetails() {
  ...
  // Check if product is in API favorites
          ...
          <div className="space-y-4">
            <div className="relative aspect-[3/4] bg-gray-100 overflow-hidden group">
              ...
              <button 
                ...
                className="absolute top-4 left-4 p-2 bg-white/90 hover:bg-white rounded-full shadow-md transition-all active:scale-90 z-10"
                aria-label="المفضلة"
              >
                <Heart className={`h-6 w-6 ${isFavorite ? 'text-red-600 fill-current' : 'text-gray-800'}`} />
              </button>
            </div>
